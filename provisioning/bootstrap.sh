#!/usr/bin/env bash
#
# YonderGate one-line bootstrap: clone (or update) the repo into /opt/yondergate and run
...
REPO_URL="${YGW_REPO_URL:-https://github.com/TechnikWeber/YonderGate.git}"
DEST="${YGW_DEST:-/opt/yondergate}"

echo "== YonderGate bootstrap =="
