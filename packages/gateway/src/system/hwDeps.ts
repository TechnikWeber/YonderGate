/**
 * Native driver module (i2c-bus) for the I²C sensors.
 *
...
export const HW_DEPS: readonly HwDepInfo[] = [
  {
    name: 'i2c-bus',
    needFor: 'INA2xx voltage/current sensors · ADS1115 ADC · I²C temperature sensors',
    apt: [],
  },
];
...
export function hwDepInfo(name: HwDepName): HwDepInfo | undefined {
